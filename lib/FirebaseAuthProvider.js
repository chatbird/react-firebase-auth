...
var FirebaseAuthProvider = (function (_super) {
    ...
    function FirebaseAuthProvider(props) {
        ...
        _this.signInWithLinkedIn = function (ref) {
            if (ref === void 0) { ref = window.location.pathname; }
        ...
        _this.getCurrentUser = function () {
            return new Promise(function (resolve, reject) {
                ...
                firebase.auth().onAuthStateChanged(function (user) { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0: return [4, this.onAuthStateChanged(user, false)];
                            case 1:
                                finalUser = _a.sent();
                                resolve(finalUser);
                                return [2];
        ...
        _this.onAuthStateChanged = function (user, login) {
            ...
            return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0:
                            if (!user) return [3, 4];
                            return [4, user.getIdToken(login)];
                        case 1:
                            firebaseToken = _a.sent();
                            if (!login) return [3, 3];
                        ...
                        case 4:
                            if (!this.props.allowAnonymousSignup) return [3, 6];
    ...
    FirebaseAuthProvider.prototype.render = function () {
        ...
        var _a = this.state, existingProviders = _a.existingProviders, pendingCredential = _a.pendingCredential, loggedIn = _a.loggedIn;
