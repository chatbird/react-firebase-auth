...
var signInWithRedirect = function (providerId) {
    ...
    return function () { return firebase_1.default.auth().signInWithRedirect(provider); };
};
var signInWithPopup = function (providerId) {
    var provider = get_provider_1.default(providerId);
    return function () { return firebase_1.default.auth().signInWithPopup(provider); };
};
var FirebaseAuthProvider = (function (_super) {
    ...
    function FirebaseAuthProvider(props) {
        ...
        _this.updateTokenForCurrentUser = function () {
            return _this.updateToken(firebase_1.default.auth().currentUser, true);
        };
        ...
        _this.setAuthStateListener = function () {
            return firebase_1.default.auth().onAuthStateChanged(_this.onAuthStateChanged.bind(_this));
        };
    ...
    FirebaseAuthProvider.prototype.signInWithCustomToken = function (token) {
        ...
        return firebase_1.default.auth().signInWithCustomToken(token)
            .then(function (user) {
            _this.log("signInWithCustomToken user", user);
            return _this.getPendingCredential()
    ...
    FirebaseAuthProvider.prototype.handleRedirect = function (pendingCredential) {
        ...
        firebase_1.default.auth().getRedirectResult().then(function (result) {
            if (result.user)
    ...
    FirebaseAuthProvider.prototype.handleExistingAccountError = function (error) {
        ...
        return this.setPendingCredential(pendingCredential)
            ...
            return firebase_1.default.auth().fetchProvidersForEmail(existingEmail);
        })
    ...
    FirebaseAuthProvider.prototype.onAuthStateChanged = function (user) {
        ...
        if (user) {
            ...
            return firebase_1.default.auth().signInAnonymously();
        }
    };
    ;
    FirebaseAuthProvider.prototype.render = function () {
        ...
        return (React.createElement(firebase_context_1.default.Provider, { value: value }, children));
    };
