...
var InnerIsAnonymous = (function (_super) {
    ...
    function InnerIsAnonymous() {
        ...
        _this.checkState = function () { return __awaiter(_this, void 0, void 0, function () {
            var user, isAnonymous;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4, this.props.getCurrentUser()];
                    case 1:
                        user = _a.sent();
                        isAnonymous = !user || user.isAnonymous;
                        if (this.mounted) {
                            this.setState({ isAnonymous: isAnonymous, loading: false });
                        }
                        return [2];
                }
            });
...
var IsAnonymous = function (props) {
    return (React.createElement(FirebaseAuthConsumer_1.default, null, function (_a) {
        var getCurrentUser = _a.getCurrentUser, loggedIn = _a.loggedIn;
        return React.createElement(InnerIsAnonymous, __assign({ getCurrentUser: getCurrentUser, loggedIn: loggedIn }, props));
    }));
};
