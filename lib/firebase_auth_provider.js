...
var append_query_1 = require("append-query");
...
var FirebaseAuthProvider = (function (_super) {
    ...
    function FirebaseAuthProvider(props) {
        ...
        _this.signInWithLinkedIn = function () { return window.location.replace(append_query_1.default(_this.props.linkedInLoginPath, { ref: window.location.href })); };
        _this.providers = [
