...
var FirebaseAuthProvider = (function (_super) {
    ...
    FirebaseAuthProvider.prototype.componentDidMount = function () {
        var _this = this;
        var _a = this.props, customToken = _a.customToken, firebaseConfig = _a.firebaseConfig;
        firebase.initializeApp(firebaseConfig);
        if (customToken) {
            firebase.auth().signOut()
                .then(function () { return _this.signInWithCustomToken(_this.props.customToken); })
            ...
            return localforage.getItem('pendingCredential')
                ...
                if (pendingCredential) {
                    return user.linkAndRetrieveDataWithCredential(pendingCredential)
                        .then(function () { return localforage.removeItem('pendingCredential'); })
