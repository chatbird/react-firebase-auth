...
var FirebaseAuthProvider = (function (_super) {
    ...
    function FirebaseAuthProvider(props) {
        ...
        _this.updateToken = function (user, forceRefresh) {
            if (forceRefresh === void 0) { forceRefresh = false; }
            return __awaiter(_this, void 0, void 0, function () {
                var firebaseToken;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4, user.getIdToken(forceRefresh)];
                        case 1:
        ...
        _this.onAuthStateChanged = function (user) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        _a.sent();
                        return [2, this.setState({ firebaseToken: firebaseToken })];
                    case 3:
                        if (this.props.allowAnonymousSignup) {
                            return [2, firebase.auth().signInAnonymously()];
                        }
                        _a.label = 4;
                    case 4: return [2];
                }
        ...
        _this.refreshToken = function () { return _this.updateToken(firebase.auth().currentUser, true); };
        ...
        _this.getFirebaseToken = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!this.isTokenExpired()) return [3, 2];
                        return [4, this.refreshToken()];
                    case 1: return [2, _a.sent()];
                    case 2: return [2, this.state.firebaseToken];
                }
            });
        }); };
        _this.getDecodedToken = function () {
            var firebaseToken = _this.state.firebaseToken;
            return firebaseToken ? jwtDecode(firebaseToken) : {};
        };
        _this.isTokenExpired = function () {
            var decodedToken = _this.getDecodedToken();
